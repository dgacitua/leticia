...
export default {
  ...
  methods: {
    writeQuery() {
      this.$router.push({ path: '/search', query: { task: this.taskId, q: this.query, p: 1 }});
    ...
    queryPage(pageNum) {
      return { path: '/search', query: { task: this.taskId, q: this.query, p: pageNum }};
    },
    resetBookmarks() {
    ...
    pagination(page) {
      ...
      this.$router.push({ path: '/search', query: { task: this.taskId, q: this.query, p: (this.currentPage || 1) }});
    },
